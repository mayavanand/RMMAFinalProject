    ...
    if learn_options['adaboost_version'] == 'python':
        if not learn_options['adaboost_CV']:
            if not classification:
                ...
                print learn_options['adaboost_learning_rate']
            else:
            ...
            print "trying to print important features"
            ...
            print(str(X.dtype))
            print(str(X.shape))
            text_file = open("GINIImportance.txt", "w")
            text_file.write("Feature importance")
            for f in clf.feature_importances_:
                text_file.write(str(f))
                text_file.write('\n')
            text_file.write("Feature importance NORMALIZED")
            for g in feature_importance:
                text_file.write(str(g))
                text_file.write('\n')
            text_file.write("feature sets: %s" % str(feature_sets))
            text_file.close()
